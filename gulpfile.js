...
gulp.task('build', gulpSequence(['clean-assets', 'clean-templates'], 'revision'));
gulp.task('production', gulpSequence(['assets', 'assets-proto'], 'serve'));
gulp.task('revision', ['assets'], getTask('revision'));
gulp.task('revision-replace', ['revision'], getTask('revision-replace'));
